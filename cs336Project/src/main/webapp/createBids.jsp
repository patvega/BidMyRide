...
<body>
 <% if (session.getAttribute("bid_response") != null) {%>
 <div><%=session.getAttribute("bid_response") %></div>
 <%session.setAttribute("bid_response", null);%>
<%} %>
...
<form action="saveBid.jsp" method="POST">
	...
	<label for="initial_price">Starting Price:</label>
	<input type="text" id="initial_price" name="initial_price"><br><br>
	
	
	<label for="min_raise">Minimum Raise:</label>
	<input type="text" id="min_price" name="min_price"><br><br>
	
	<label for="reserve_price">Reserve Price:</label>
	<input type="text" id="reserve_price" name="reserve_price"><br><br>
