...
<button type="button" onclick="location.href='createRep.jsp';">Create Representative</button>
<button type="button" onclick="location.href='salesReport.jsp';">Sales Report</button>
